...
static int32 Generic_ADCS_VerifyCmdLength(CFE_MSG_Message_t *msg,
...
void ADCS_AppMain(void) {
  ...
  */
  while (CFE_ES_RunLoop(&Generic_ADCS_AppData.RunStatus) == true) {
    ...
    */
    status =
        CFE_SB_ReceiveBuffer((CFE_SB_Buffer_t **)&Generic_ADCS_AppData.MsgPtr,
                             Generic_ADCS_AppData.CmdPipe, CFE_SB_PEND_FOREVER);
...
static int32 Generic_ADCS_AppInit(void) {
  ...
  */
  ...
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "Generic_ADCS: Error registering for event services: 0x%08X\n",
        (unsigned int)status);
    return status;
  }
  ...
  */
  status = CFE_SB_CreatePipe(&Generic_ADCS_AppData.CmdPipe,
                             GENERIC_ADCS_PIPE_DEPTH, "ADCS_CMD_PIPE");
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_ADCS_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_ADCS_CMD_MID),
                            Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_ADCS_REQ_HK_MID),
                            Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_ADCS_ADAC_UPDATE_MID),
                            Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_ADCS_SUB_REQ_HK_ERR_EID, CFE_EVS_EventType_ERROR,
  ...
  ** telemetry that has been defined in the Generic_ADCS_HkTelemetryPkt for this
  *app.
  */
  ...
  */
  CFE_MSG_Init(CFE_MSG_PTR(Generic_ADCS_AppData.DIPacket.TlmHeader),
               CFE_SB_ValueToMsgId(GENERIC_ADCS_DI_MID), GENERIC_ADCS_DI_LNGTH);
  CFE_MSG_Init(CFE_MSG_PTR(Generic_ADCS_AppData.ADPacket.TlmHeader),
               CFE_SB_ValueToMsgId(GENERIC_ADCS_AD_MID), GENERIC_ADCS_AD_LNGTH);
  CFE_MSG_Init(CFE_MSG_PTR(Generic_ADCS_AppData.GNCPacket.TlmHeader),
               CFE_SB_ValueToMsgId(GENERIC_ADCS_GNC_MID),
               GENERIC_ADCS_GNC_LNGTH);
  CFE_MSG_Init(CFE_MSG_PTR(Generic_ADCS_AppData.ACSPacket.TlmHeader),
               CFE_SB_ValueToMsgId(GENERIC_ADCS_AC_MID), GENERIC_ADCS_AC_LNGTH);
  CFE_MSG_Init(CFE_MSG_PTR(Generic_ADCS_AppData.DOPacket.TlmHeader),
               CFE_SB_ValueToMsgId(GENERIC_ADCS_DO_MID), GENERIC_ADCS_DO_LNGTH);

  CFE_MSG_Init(CFE_MSG_PTR(Generic_ADCS_AppData.MtbPctOnCmd.CmdHeader),
               CFE_SB_ValueToMsgId(GENERIC_TORQUER_CMD_MID),
               GENERIC_TORQUER_ALL_PERCENT_ON_CMD_LEN);
  CFE_MSG_SetFcnCode((CFE_MSG_Message_t *)&Generic_ADCS_AppData.MtbPctOnCmd,
                     GENERIC_TORQUER_CONFIG_ALL_CC);
  CFE_MSG_Init(CFE_MSG_PTR(Generic_ADCS_AppData.RwCmd.CmdHeader),
               CFE_SB_ValueToMsgId(GENERIC_RW_APP_CMD_MID), GENERIC_RW_CMD_LEN);
  CFE_MSG_SetFcnCode((CFE_MSG_Message_t *)&Generic_ADCS_AppData.RwCmd,
                     GENERIC_RW_APP_SET_TORQUE_CC);
  ...
  */
  ...
  if (adcs_in == NULL) {
    CFE_EVS_SendEvent(GENERIC_ADCS_FOPEN_ERR_EID, CFE_EVS_EventType_ERROR,
                      "Error opening cf/Inp_DI.txt");
    return OS_ERROR;
  }
  ...
  if (adcs_in == NULL) {
    CFE_EVS_SendEvent(GENERIC_ADCS_FOPEN_ERR_EID, CFE_EVS_EventType_ERROR,
                      "Error opening cf/Inp_ADAC.txt");
    return OS_ERROR;
  }
  Generic_ADCS_init_attitude_determination_and_attitude_control(
      adcs_in, &Generic_ADCS_AppData.ADPacket.Payload,
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_MAG_DEVICE_TLM_MID),
                            Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog("Generic_ADCS App: Error Subscribing to "
                         "GENERIC_MAG_DEVICE_TLM_MID, RC = 0x%08lX\n",
                         (unsigned long)status);
    return (status);
  }
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_FSS_DEVICE_TLM_MID),
                            Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog("Generic_ADCS App: Error Subscribing to "
                         "GENERIC_FSS_DEVICE_TLM_MID, RC = 0x%08lX\n",
                         (unsigned long)status);
    return (status);
  }
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_CSS_DEVICE_TLM_MID),
                            Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog("Generic_ADCS App: Error Subscribing to "
                         "GENERIC_CSS_DEVICE_TLM_MID, RC = 0x%08lX\n",
                         (unsigned long)status);
    return (status);
  }
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_IMU_DEVICE_TLM_MID),
                            Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog("Generic_ADCS App: Error Subscribing to "
                         "GENERIC_IMU_DEVICE_TLM_MID, RC = 0x%08lX\n",
                         (unsigned long)status);
    return (status);
  }
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_RW_APP_HK_TLM_MID),
                            Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog("Generic_ADCS App: Error Subscribing to "
                         "GENERIC_RW_APP_HK_TLM_MID, RC = 0x%08lX\n",
                         (unsigned long)status);
    return (status);
  }
  status =
      CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_STAR_TRACKER_DEVICE_TLM_MID),
                       Generic_ADCS_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog("Generic_ADCS App: Error Subscribing to "
                         "GENERIC_STAR_TRACKER_DEVICE_TLM_MID, RC = 0x%08lX\n",
                         (unsigned long)status);
    return (status);
  }
  ...
  status = CFE_EVS_SendEvent(
      GENERIC_ADCS_STARTUP_INF_EID, CFE_EVS_EventType_INFORMATION,
      "Generic_ADCS App Initialized. Version %d.%d.%d.%d",
      GENERIC_ADCS_MAJOR_VERSION, GENERIC_ADCS_MINOR_VERSION,
      GENERIC_ADCS_REVISION, GENERIC_ADCS_MISSION_REV);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "Generic_ADCS: Error sending initialization event: 0x%08X\n",
        (unsigned int)status);
  }
  return status;
}
...
static void Generic_ADCS_ProcessCommandPacket(void) {
  ...
  /*
  ** Ground Commands with command codes fall under the GENERIC_ADCS_CMD_MID
  *(Message ID)
  */
  ...
  */
  ...
  case GENERIC_MAG_DEVICE_TLM_MID:
    Generic_ADCS_ingest_generic_mag(Generic_ADCS_AppData.MsgPtr,
                                    &Generic_ADCS_AppData.DIPacket.Payload.Mag);
    break;

  case GENERIC_FSS_DEVICE_TLM_MID:
    Generic_ADCS_ingest_generic_fss(Generic_ADCS_AppData.MsgPtr,
                                    &Generic_ADCS_AppData.DIPacket.Payload.Fss);
    break;

  case GENERIC_CSS_DEVICE_TLM_MID:
    Generic_ADCS_ingest_generic_css(Generic_ADCS_AppData.MsgPtr,
                                    &Generic_ADCS_AppData.DIPacket.Payload.Css);
    break;

  case GENERIC_IMU_DEVICE_TLM_MID:
    Generic_ADCS_ingest_generic_imu(Generic_ADCS_AppData.MsgPtr,
                                    &Generic_ADCS_AppData.DIPacket.Payload.Imu);
    break;

  case GENERIC_RW_APP_HK_TLM_MID:
    Generic_ADCS_ingest_generic_rw(Generic_ADCS_AppData.MsgPtr,
                                   &Generic_ADCS_AppData.DIPacket.Payload.Rw);
    break;

  case GENERIC_STAR_TRACKER_DEVICE_TLM_MID:
    Generic_ADCS_ingest_generic_st(Generic_ADCS_AppData.MsgPtr,
                                   &Generic_ADCS_AppData.DIPacket.Payload.St);
    break;

  case GENERIC_ADCS_ADAC_UPDATE_MID:
    Generic_ADCS_execute_attitude_determination_and_attitude_control(
        &Generic_ADCS_AppData.DIPacket.Payload,
        &Generic_ADCS_AppData.ADPacket.Payload,
        &Generic_ADCS_AppData.GNCPacket.Payload,
        &Generic_ADCS_AppData.ACSPacket.Payload);
    Generic_ADCS_output_to_actuators(&Generic_ADCS_AppData.GNCPacket.Payload,
                                     &Generic_ADCS_AppData.DOPacket.Payload,
                                     &Generic_ADCS_AppData.MtbPctOnCmd,
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(GENERIC_ADCS_PROCESS_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
                      "Generic_ADCS: Invalid command packet, MID = 0x%x",
...
static void Generic_ADCS_ProcessGroundCommand(void) {
  ...
  case GENERIC_ADCS_NOOP_CC:
    ...
    */
    if (Generic_ADCS_VerifyCmdLength(Generic_ADCS_AppData.MsgPtr,
                                     sizeof(Generic_ADCS_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      /* Second, send EVS event on successful receipt ground commands*/
      CFE_EVS_SendEvent(GENERIC_ADCS_CMD_NOOP_INF_EID,
  ...
  */
  case GENERIC_ADCS_RESET_COUNTERS_CC:
    if (Generic_ADCS_VerifyCmdLength(Generic_ADCS_AppData.MsgPtr,
                                     sizeof(Generic_ADCS_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_ADCS_CMD_RESET_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  case GENERIC_ADCS_SET_MODE_CC:
    if (Generic_ADCS_VerifyCmdLength(Generic_ADCS_AppData.MsgPtr,
                                     sizeof(Generic_ADCS_Mode_cmd_t)) ==
        OS_SUCCESS) {
      Generic_ADCS_Mode_cmd_t *cmd;
      cmd = (Generic_ADCS_Mode_cmd_t *)Generic_ADCS_AppData.MsgPtr;
      Generic_ADCS_AppData.GNCPacket.Payload.Mode =
          cmd->Mode; // Keep the current value in **one** place
      CFE_EVS_SendEvent(GENERIC_ADCS_SET_MODE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  case GENERIC_ADCS_SET_MOMENTUM_MANAGEMENT_CC:
    if (Generic_ADCS_VerifyCmdLength(
            Generic_ADCS_AppData.MsgPtr,
            sizeof(Generic_ADCS_MomentumManagement_cmd_t)) == OS_SUCCESS) {
      Generic_ADCS_MomentumManagement_cmd_t *cmd;
      cmd =
          (Generic_ADCS_MomentumManagement_cmd_t *)Generic_ADCS_AppData.MsgPtr;
      Generic_ADCS_AppData.GNCPacket.Payload.HmgmtOn =
          cmd->MomentumManagement; // Keep the current value in **one** place
      CFE_EVS_SendEvent(GENERIC_ADCS_SET_MOMENTUM_MANAGEMENT_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "***ADCS*** Changed momentum management to: %u",
                        cmd->MomentumManagement);
    } else {
      Generic_ADCS_AppData.HkTelemetryPkt.CommandErrorCount++;
    }
    break;
  ...
  case GENERIC_ADCS_INERTIAL_QUATERNION_CC:
    if (Generic_ADCS_VerifyCmdLength(Generic_ADCS_AppData.MsgPtr,
      ...
      CFE_EVS_SendEvent(GENERIC_ADCS_SET_INER_QUAT_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "Set inertial quaternion to: %f,%f,%f,%f", cmd->qbn[0],
                        cmd->qbn[1], cmd->qbn[2], cmd->qbn[3]);
    } else {
      Generic_ADCS_AppData.HkTelemetryPkt.CommandErrorCount++;
    }
    break;
  ...
  */
  default:
    ...
    Generic_ADCS_AppData.HkTelemetryPkt.CommandErrorCount++;
    CFE_EVS_SendEvent(GENERIC_ADCS_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
                      "Generic_ADCS: Invalid command code for packet, MID = "
                      "0x%x, cmdCode = 0x%x",
...
static void Generic_ADCS_ReportHousekeeping(void) {
  ...
  CFE_SB_TimeStampMsg(
      (CFE_MSG_Message_t *)&Generic_ADCS_AppData.HkTelemetryPkt);
  CFE_SB_TransmitMsg((CFE_MSG_Message_t *)&Generic_ADCS_AppData.HkTelemetryPkt,
                     true);
}
...
static int32 Generic_ADCS_SendDICommand(void) {
  ...
  return CFE_SB_TransmitMsg((CFE_MSG_Message_t *)&Generic_ADCS_AppData.DIPacket,
                            true);
}

static int32 Generic_ADCS_SendADCommand(void) {
  CFE_SB_TimeStampMsg((CFE_MSG_Message_t *)&Generic_ADCS_AppData.ADPacket);
  return CFE_SB_TransmitMsg((CFE_MSG_Message_t *)&Generic_ADCS_AppData.ADPacket,
                            true);
}

static int32 Generic_ADCS_SendGNCCommand(void) {
  CFE_SB_TimeStampMsg((CFE_MSG_Message_t *)&Generic_ADCS_AppData.GNCPacket);
  return CFE_SB_TransmitMsg(
      (CFE_MSG_Message_t *)&Generic_ADCS_AppData.GNCPacket, true);
}

static int32 Generic_ADCS_SendACCommand(void) {
  CFE_SB_TimeStampMsg((CFE_MSG_Message_t *)&Generic_ADCS_AppData.ACSPacket);
  return CFE_SB_TransmitMsg(
      (CFE_MSG_Message_t *)&Generic_ADCS_AppData.ACSPacket, true);
}

static int32 Generic_ADCS_SendDOCommand(void) {
  CFE_SB_TimeStampMsg((CFE_MSG_Message_t *)&Generic_ADCS_AppData.DOPacket);
  return CFE_SB_TransmitMsg((CFE_MSG_Message_t *)&Generic_ADCS_AppData.DOPacket,
                            true);
}
...
static int32 Generic_ADCS_VerifyCmdLength(CFE_MSG_Message_t *msg,
  ...
  if (expected_length == actual_length) {
    ...
    CFE_EVS_SendEvent(
        GENERIC_ADCS_LEN_ERR_EID, CFE_EVS_EventType_ERROR,
