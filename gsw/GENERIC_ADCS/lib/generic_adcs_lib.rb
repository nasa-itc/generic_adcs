...
# ****Note these files will be converted and imported via (uncommented):
...
GENERIC_CSS_DEVICE_TRUTH_MARGIN = 0.05
GENERIC_IMU_DEVICE_ANGULAR_DIFF = 0.05
GENERIC_IMU_DEVICE_LINEAR_DIFF = 0.05
GENERIC_MAG_DEVICE_NT_DIFFERENCE = 0.05
...
def adcs_cmd(*command):
    ...
    check(f"GENERIC_ADCS GENERIC_ADCS_HK_TLM CMD_COUNT >= {count}")
...
def confirm_adcs_data():
    ...
    x_ang_rate_before = abs(tlm("GENERIC_IMU GENERIC_IMU_DATA_TLM X_ANGULAR_RATE"))
    y_ang_rate_before = abs(tlm("GENERIC_IMU GENERIC_IMU_DATA_TLM Y_ANGULAR_RATE"))
    z_ang_rate_before = abs(tlm("GENERIC_IMU GENERIC_IMU_DATA_TLM Z_ANGULAR_RATE"))

    adcs_bdot()

    diff = 0.05
    
    wait_check(f"GENERIC_IMU GENERIC_IMU_DATA_TLM X_ANGULAR_RATE < {x_ang_rate_before}", GENERIC_ADCS_MODE_CHECK_TIMEOUT)
    wait_check(f"GENERIC_IMU GENERIC_IMU_DATA_TLM Y_ANGULAR_RATE < {y_ang_rate_before}", GENERIC_ADCS_MODE_CHECK_TIMEOUT)
    wait_check(f"GENERIC_IMU GENERIC_IMU_DATA_TLM Z_ANGULAR_RATE < {z_ang_rate_before}", GENERIC_ADCS_MODE_CHECK_TIMEOUT)
    ...
    qbn0 = abs(tlm("GENERIC_ADCS GENERIC_ADCS_GNC QBN_0"))
    qbn1 = abs(tlm("GENERIC_ADCS GENERIC_ADCS_GNC QBN_1"))
    qbn2 = abs(tlm("GENERIC_ADCS GENERIC_ADCS_GNC QBN_2"))
    qbn3 = abs(tlm("GENERIC_ADCS GENERIC_ADCS_GNC QBN_3"))
...
def adcs_confirm_fss_data():
    ...
    get_fss_hk()
    check(f"GENERIC_FSS GENERIC_FSS_HK_TLM DEVICE_COUNT >= {dev_cmd_cnt}")
    check(f"GENERIC_FSS GENERIC_FSS_HK_TLM DEVICE_ERR_COUNT == {dev_cmd_err_cnt}")
...
def adcs_confirm_imu_data():
    ...
    get_generic_imu_hk()
    check(f"GENERIC_IMU GENERIC_IMU_HK_TLM DEVICE_COUNT >= {dev_cmd_cnt}")
    check(f"GENERIC_IMU GENERIC_IMU_HK_TLM DEVICE_ERR_COUNT == {dev_cmd_err_cnt}")
...
def adcs_confirm_mag_data():
    ...
    get_generic_mag_hk()
    check(f"GENERIC_MAG GENERIC_MAG_HK_TLM DEVICE_COUNT >= {dev_cmd_cnt}")
    check(f"GENERIC_MAG GENERIC_MAG_HK_TLM DEVICE_ERR_COUNT == {dev_cmd_err_cnt}")
...
def adcs_confirm_st_data():
    ...
    adcs_Q0 = abs(tlm("GENERIC_ADCS GENERIC_ADCS_DI ST_Q_0"))
    ...
    adcs_Q1 = abs(tlm("GENERIC_ADCS GENERIC_ADCS_DI ST_Q_1"))
    ...
    adcs_Q2 = abs(tlm("GENERIC_ADCS GENERIC_ADCS_DI ST_Q_2"))
    ...
    adcs_Q3 = abs(tlm("GENERIC_ADCS GENERIC_ADCS_DI ST_Q_3"))
